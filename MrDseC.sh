...
figlet "Tools MrD"
echo $r"=========================================="
echo $w"=Author"$r" : "$w"MrDseC                         ="
echo $w"=Youtube"$r" : "$w"MrD seC                       ="
echo $w"=Github"$r" : "$w"https://github.com/MrDseC/Tools="
echo $r"=========================================="
echo 
echo $w"pilih menu nya "$r"fr13nds"
